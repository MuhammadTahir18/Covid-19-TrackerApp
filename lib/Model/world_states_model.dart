class WorldStatesModel {
  ...
  final num _updated;
  final num _cases;
  final num _todayCases;
  final num _deaths;
  final num _todayDeaths;
  final num _recovered;
  final num _todayRecovered;
  final num _active;
  final num _critical;
  final num _casesPerOneMillion;
  final num _deathsPerOneMillion;
  final num _tests;
  final num _testsPerOneMillion;
  final num _population;
  final num _oneCasePerPeople;
  final num _oneDeathPerPeople;
  final num _oneTestPerPeople;
  final num _activePerOneMillion;
  final num _recoveredPerOneMillion;
  final num _criticalPerOneMillion;
  final num _affectedCountries;
